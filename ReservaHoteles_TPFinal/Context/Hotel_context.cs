...
namespace ReservaHoteles_TPFinal.Context
{
    public class Hotel_context: DbContext
    {
        ...
        {   
            ...
            //Ariel
            //optionsBuilder.UseSqlServer("Data Source = DESKTOP-8G3D5B2\\SQLEXPRESS ; Initial Catalog = Hotel_PNT; Integrated Security = true; Encrypt=true; TrustServerCertificate=true");
        }
    }
}
